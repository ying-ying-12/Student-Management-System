            ...
            <ul class="nav nav-drawer">
                <li class="nav-item active">
                    <a href="${pageContext.request.contextPath}/">
                        <i class="mdi mdi-home"></i> 后台首页
                    </a>
                </li>
                <li class="nav-item nav-item-has-subnav open">
                    <a href="javascript:void(0)">
                        <i class="mdi mdi-format-align-justify"></i> 功能
                    </a>
                    <ul class="nav nav-subnav">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/clazz">班级信息</a>
                        </li>
                    </ul>
                </li>
            </ul>
                ...
                <li class="dropdown dropdown-profile">
                    <a href="javascript:void(0)" data-toggle="dropdown">
                        <img class="img-avatar img-avatar-48 m-r-10"
                             src="${pageContext.request.contextPath}/assets/images/users/avatar.jpg" />
                        <!-- 使用 EL 表达式动态显示用户名/姓名 -->
                        <span>
