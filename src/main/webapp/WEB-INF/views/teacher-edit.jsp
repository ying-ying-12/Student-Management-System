      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              <div class="card-body">
                <form id="myForm" action="${pageContext.request.contextPath}/teacher?r=edit" method="post">
                  ...
                  <div class="form-group">
                    <label >姓名</label>
                    <input required value="${entity.tname}" class="form-control" type="text" name="tname">
                  </div>
